...
class FileCondition(BaseView):
    ...
    source_type: Optional[str] = Field(default=None, description="来源类型：flow/agent")
    flow_id: Optional[int] = Field(default=None, description="所属流程ID")
    original_name: Optional[str] = Field(default=None, description="原始文件名")
    mime_type: Optional[str] = Field(
        default=None, description="MIME类型过滤，如 image/*,.pdf"
    )
...
class FileBase(BaseView):
    ...
    source_type: Optional[str] = Field(default=None, description="来源类型：flow/agent")
    original_name: Optional[str] = Field(default=None, description="原始文件名")
    file_path: Optional[str] = Field(default=None, description="存储路径")
    file_type: Optional[str] = Field(default=None, description="文件扩展名")
